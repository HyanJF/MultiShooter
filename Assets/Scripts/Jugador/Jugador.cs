...
public class Jugador : NetworkBehaviour
{
    ...
    [SyncVar(hook = nameof(OnHatIndexChanged))]
    private int currentHatIndex = -1;
    private InfoSombrero infoSombrero;
    ...
    public override void OnStartLocalPlayer()
    {
        ...
        infoSombrero = FindFirstObjectByType<InfoSombrero>();
        if (infoSombrero != null)
        {
            CommandChanceHat(infoSombrero.PideSombrero());
        }
    ...
    [Command]
    private void CommandChanceHat(int index)
    {
